...
class AudioLoop:
            ...
            try:
                async for response in turn:
                    ...
                    if function_call := response.tool_call:
                        ...
                        asyncio.create_task(
                            notifier.send(
                                "Agent Function Call [Internal Agent884]",
    ...
    base_prompt = " Whatever factual statements will user will make pass that to the function call to test whether it is true or false . Do this silently dont say anything , just listen and do fucntion call. Dont question Back, just send everything ti the funntion call, Just Function call dont say anything. just return the tool call. and You dont wait for the response you pass it directly to the module. you pass the claim to the function and forgot. you are desgined just to make a function call thats it."
